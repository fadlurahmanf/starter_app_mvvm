package com.fadlurahmanf.starterappmvvm.unknown.utils.call
...
class CallBroadcastReceiver: BroadcastReceiver(){
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        when(intent?.action){
            ...
            ACTION_ACCEPT_CALL -> {
                val notificationId:Int = intent.extras?.getBundle(EXTRA_DATA)?.getInt(
                    CallNotificationHelper.EXTRA_NOTIFICATION_ID
                )!!
