...
import com.fadlurahmanf.starterappmvvm.core.constant.NotificationConstant
import java.io.File
...
class DownloadService:Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val notificationId:Int? = intent?.extras?.getInt(DownloadNotificationHelper.EXTRA_NOTIFICATION_ID)
        ...
        val uri = Uri.withAppendedPath(Uri.fromFile(file), "starter_app_mvvm_${Random.nextInt(999)}.mp4")
                ...
                if (cursor.getColumnIndex(DownloadManager.COLUMN_TOTAL_SIZE_BYTES) >= 0){
                    ...
                    if (cursor.getColumnIndex(DownloadManager.COLUMN_BYTES_DOWNLOADED_SO_FAR) >= 0){
                        ...
                        data.apply {
                            ...
                            putInt(DownloadNotificationHelper.EXTRA_CURRENT_PROGRESS_SIZE, currentSize)
                        }
