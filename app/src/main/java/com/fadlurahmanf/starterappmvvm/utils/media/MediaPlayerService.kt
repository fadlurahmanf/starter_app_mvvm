        ...
        when(intent?.getStringExtra(ACTION)){
                ...
                if (urlAudio != null){
                    ...
                    mediaPlayer?.setOnPreparedListener {
                        ...
                        val data = getBasedBundle().apply {
                            putString(MediaPlayerNotificationHelper.EXTRA_STATE, MediaPlayerNotificationHelper.STATE_PLAYING)
                        }
            ...
            ACTION_PAUSE -> {
                if(mediaPlayer != null && mediaPlayer?.isPlaying == true){
                    ...
                    val data = getBasedBundle().apply {
                        putString(MediaPlayerNotificationHelper.EXTRA_STATE, MediaPlayerNotificationHelper.STATE_PAUSED)
